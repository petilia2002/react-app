  ...
  return (
    <div className="border-b border-gray-200">
      <div className="container mx-auto flex items-center py-6 gap-4">
        ...
        <div className="flex items-center gap-2 rounded px-3 py-1 border border-gray-200 hover:border-gray-500 transition focus-within:border-gray-500 flex-grow">
